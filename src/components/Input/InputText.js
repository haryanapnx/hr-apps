      ...
      <ContentView>
        <View>
          {name !== 'password' ? (
            ...
            <LeftContent
              style={
                this.state.isFocused && {borderColor: '#ff9900', borderWidth: 2}
              }>
              <View style={{width: '90%'}}>
                <StyledInput
                  onChangeText={text => this.onChangeText(text)}
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.onVisible('password', this.props.secureText)
                }
                style={{
                  width: '10%',
                  justifyContent: 'center',
                ...
                <Text>
                  {this.props.secureText ? (
                    <Icon name="md-eye-off" size={18} />
                  ) : (
                    <Icon name="md-eye" size={18} />
                  )}{' '}
                </Text>
              </TouchableOpacity>
              {this.state.isFocused && (
